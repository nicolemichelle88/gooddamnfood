...
function perfect_blog_abouttheme() {    	
	add_theme_page( esc_html__('About Perfect Blog Theme', 'perfect-blog'), esc_html__('About Perfect Blog Theme', 'perfect-blog'), 'edit_theme_options', 'perfect_blog_guide', 'perfect_blog_mostrar_guide');   
}
...
?>
 <div class="wrapper-info">
	...
	<button class="tablink" onclick="openPage('Contact', this, '')"><?php esc_html_e('Premium Theme info', 'perfect-blog'); ?>Plugin</button>
	</div>
